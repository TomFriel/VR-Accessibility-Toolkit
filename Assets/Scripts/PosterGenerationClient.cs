...
public class PosterGenerationClient : MonoBehaviour
{
    ...
    IEnumerator SendImageToApi()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Post(apiUrl, form))
        {
            ...
            {
                var driver = FindFirstObjectByType<CvdModeDriver>();
                var mode = driver != null ? driver.CurrentMode : CvdModeDriver.CvdMode.Normal;
                ...
                if (accessibilityManager != null)
                {
                    linkedPoster.ApplyFixState(accessibilityManager.applyFix, accessibilityManager.applyFixPlus, mode);
                }
                else
                {
